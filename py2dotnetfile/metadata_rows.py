...
def get_blob_location_for_offset(pe, offset):
    """
...
def get_guid_location_for_offset(pe, offset):
    """
    """
    # I'm just going to go with 4 bytes for now...
...
def get_table_row_location(pe, table_name, table_index):
    """
...
class METADATA_TABLE_ROW(BinaryStructure):
    ...
    def __init__(self, pe, addr = None, string_representation = None, byte_buffer = None):
    ...
    def create_string_stream_field_value(self, field_name):
        """
    ...
    def create_guid_stream_field_value(self, field_name):
        """
    ...
    def create_blob_stream_field_value(self, field_name):
        """
    ...
    def create_table_reference(self, field_name, table_name):
        """
    ...
    def create_variable_length_table_reference(self, field_name, type_name_param = None):
        """
...
class MODULE_TABLE_ROW(METADATA_TABLE_ROW):
    ...
    """
    def __init__(self, pe, addr = None, byte_buffer = None):
...
def get_metadata_row_class_for_table(table_name):
    """
    maps between string represents a table name (such as "TypeRef") to
    it appropriate class
    :param table_nameing represents a table name
    :return:
    """
